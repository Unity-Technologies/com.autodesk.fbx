...
namespace Autodesk.Fbx.PerformanceTests
{
    ...
    public class PerformanceTest
    {
        protected string exeFileName {
            get {
#if UNITY_EDITOR_WIN
                return Path.GetFullPath("Packages/com.autodesk.fbx/Tests/Data~/PerformanceBenchmarks-win-x64.exe");
#elif UNITY_EDITOR_OSX
                return Path.GetFullPath("Packages/com.autodesk.fbx/Tests/Data~/PerformanceBenchmarks-mac-x64");
#elif UNITY_EDITOR_LINUX
                return Path.GetFullPath("Packages/com.autodesk.fbx/Tests/Data~/PerformanceBenchmarks-linux-x64");
#else
