...
cmake $FBXSDK_CSHARP_PATH -DCMAKE_INSTALL_PREFIX:PATH=FbxSharpBuild/tests/UnityTests/Assets/Plugins
make 
make install
```
...
cmake %FBXSDK_CSHARP_PATH -G"Visual Studio 14 2015 Win64" -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX:PATH=FbxSharpBuild/tests/UnityTests/Assets/Plugins
