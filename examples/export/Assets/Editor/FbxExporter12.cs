...
namespace UnityEngine.Formats.FbxSdk.Examples
{
    namespace Editor
    {
        public class FbxExporter12 : System.IDisposable
        {
            ...
            const string MenuItemName = "File/Export FBX/12. Skinned mesh with animation";

            const string FileBaseName = "example_skinned_mesh_w_animation";
            ...
            protected void ExportSkinnedMesh (GameObject unityGo, FbxScene fbxScene, FbxNode fbxParentNode)
            {
                ...
                // export skeleton
                if (ExportSkeleton (unitySkin.gameObject, fbxScene)) 
                {
                    // export skin mesh
