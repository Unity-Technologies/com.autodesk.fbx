...
# If we are using a custom FBX SDK, don't try finding a different version
if (NOT USE_CUSTOM_FBXSDK)
    ...
    # without NO_DEFAULT_PATH, the default paths will be searched first, but for a custom FBX SDK
    # we only care about the inputted path.
    find_path(FBXSDK_INCLUDE_DIR fbxsdk.h PATHS ${FBXSDK_INCLUDE_PATHS} NO_DEFAULT_PATH)
endif()
...
if(${CMAKE_SYSTEM_NAME} STREQUAL "Windows")
  if (USE_CUSTOM_FBXSDK)
    find_library(XML2_LIBRARY libxml2-md.lib PATHS ${FBXSDK_LIB_PATHS})
    find_library(Z_LIBRARY zlib-md.lib PATHS ${FBXSDK_LIB_PATHS})
    list(APPEND FBXSDK_LIBRARY ${XML2_LIBRARY} ${Z_LIBRARY})
  endif()
endif()
