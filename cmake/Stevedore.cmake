function(stevedore command)
    ...
    message(WARNING "Before Bee")
    set(BEE_OUTPUT "")
        execute_process(COMMAND ${CMAKE_COMMAND} -E env BEE_INTERNAL_STEVEDORE_7ZA=${7ZA_NATIVE} ${MONO} ${BEE} steve internal-unpack ${repo_name} ${artifact_id} ${target_path} ERROR_VARAIBLE BEE_OUTPUT OUTPUT_VARIABLE BEE_OUTPUT)
    message(WARNING "After Bee: ${BEE_OUTPUT}")
    endif()
endfunction()
