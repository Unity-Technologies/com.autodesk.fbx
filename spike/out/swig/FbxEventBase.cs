...
public class FbxEventBase : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          examplePINVOKE.delete_FbxEventBase(swigCPtr);
        }
  ...
  public virtual int GetTypeId() {
    int ret = examplePINVOKE.FbxEventBase_GetTypeId(swigCPtr);
    return ret;
  }

  public virtual string GetEventName() {
    string ret = examplePINVOKE.FbxEventBase_GetEventName(swigCPtr);
    return ret;
  }
